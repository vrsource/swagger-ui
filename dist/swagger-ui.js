...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['endpoint'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  


  return "<li class=\"endpoint\">\r\n  <div class='description'>\r\n  </div>\r\n  <ul class='operations'>\r\n  </div>\r\n</li>\r\n\r\n";
  });
})();
...
(function() {
  var ContentTypeView, EndpointView, HeaderView, MainView, OperationView, ParameterView, ResourceView, SignatureView, StatusCodeView, SwaggerUi,
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.render = function() {
      var empty_endpoint, endpoint, endpoint_el, operation, _i, _j, _len, _len1, _ref, _ref1;
      $(this.el).html(Handlebars.templates.resource(this.model));
      this.number = 0;
      if (this.model.endpointsArray != null) {
        _ref = this.model.endpointsArray;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          endpoint = _ref[_i];
        ...
        $('.endpoints', $(this.el)).append(endpoint_el);
        _ref1 = this.model.operationsArray;
    ...
    ResourceView.prototype.addEndpoint = function(endpoint) {
      var endpointView;
      endpointView = new EndpointView({
        model: endpoint
      });
      return $('.endpoints', $(this.el)).append(endpointView.render().el);
    };
    ...
    ResourceView.prototype.addOperation = function(operation) {
      ...
      $('.operations', $(this.el)).append(operationView.render().el);
      return this.number++;
    };
  ...
  EndpointView = (function(_super) {
    ...
    function EndpointView() {
      EndpointView.__super__.constructor.apply(this, arguments);
    }

    EndpointView.prototype.initialize = function() {};

    EndpointView.prototype.render = function() {
      var operation, _i, _len, _ref;
      this.setElement($(Handlebars.templates.endpoint(this.model)));
      this.number = 0;
    ...
    EndpointView.prototype.addOperation = function(operation) {
      var operationView;
      operation.number = this.number;
      operationView = new OperationView({
        model: operation,
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.render = function() {
      ...
      this.setElement($(Handlebars.templates.operation(this.model)));
